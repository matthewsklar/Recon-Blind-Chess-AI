...
def play_local_game(white_player, black_player, player_names):
    ...
    white_game_history = white_player.handle_game_end(winner_color, winner_reason)
    black_game_history = black_player.handle_game_end(winner_color, winner_reason)
    output.write("Game Over!\n")
    if winner_color is not None:
        output.write(winner_reason)
    else:
        output.write('Draw!')
    return winner_color, winner_reason, white_game_history, black_game_history
